...
3. [`01_프로젝트_구조.md`](01_프로젝트_구조.md) — 저장소·디렉터리·패키지 지도(어디에 무엇이 있는가).
4. [`product/01_본개발_PRD.md`](product/01_본개발_PRD.md) — 왜 이 범위·잠근 결정.
5. [`guide/04_backend_가이드.md`](guide/04_backend_가이드.md) — 구조·규약·확장법(백엔드 작업 시).
6. [`progress/03_context-notes.md`](progress/03_context-notes.md) 최신 항목 — 현재 맥락·시행착오.
...
| **저장소 구조·코드 위치 파악(어디에 무엇이)** | [`01_프로젝트_구조.md`](01_프로젝트_구조.md) |
...
| (루트) `01_프로젝트_구조.md` | 저장소 구조도 — 디렉터리·패키지 지도 | 활성 |
