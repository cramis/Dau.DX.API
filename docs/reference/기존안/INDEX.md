...
| 4   | [화면 명세서](04_화면_명세서.md)                        | 설계         | 12개 화면 wireframe·필드·동작·권한                     |
...
| 12  | [프로젝트 구조](12_프로젝트_구조.md)                    | 구조         | 루트·mockup·frontend·backend·deploy·doc 디렉토리 단일 출처 |
...
5. [12 프로젝트 구조](12_프로젝트_구조.md) — 어디에 무엇이 있는가
6. [11 마일스톤](11_마일스톤_및_위험관리.md) — 언제 무엇을 끝내야 하는가

### Phase 1 (Mockup) 작업자
1. [07 Mockup 개발 계획](07_Mockup_개발_계획.md) — 메인 가이드
2. [12 프로젝트 구조 §4](12_프로젝트_구조.md#4-mockup--phase-1-시연-nextjs-단독) — `mockup/` 폴더 트리
3. [04 화면 명세서](04_화면_명세서.md) — 어떤 화면을 만드는가
4. [05 API 명세서](05_API_명세서.md) §5.5 — 샘플 게이트웨이 시연 스펙

### Phase 3 (정식 개발) 작업자
1. [08 본 개발 계획](08_본_개발_계획.md) — 메인 가이드
2. [12 프로젝트 구조 §5~§7](12_프로젝트_구조.md#5-frontend--phase-3-정식-nextjs) — `frontend/` `backend/` `deploy/` 폴더 트리
3. [06 데이터 모델](06_데이터_모델_설계서.md) — Oracle 19c 스키마
4. [09 보안/인증](09_보안_및_인증_설계서.md) — 인증·인가 구현
5. [10 CI/CD 운영](10_CICD_및_운영_가이드.md) — 배포 파이프라인
...
| 1 | Mockup 1차 완성 | 1주 | mockup/ 화면 12개 + 샘플 게이트웨이 5개 |
...
**작성일**: 2026-05-08 (12 추가: 2026-05-09)
**문서 수**: INDEX + 12개 = **13개 문서**, 각 500라인 이하
...
`/doc` 은 본 프로젝트의 **단일 문서 허브** 다. 상세는 [12 프로젝트 구조 §8](12_프로젝트_구조.md#8-doc--문서-허브-) 참조.

```
doc/
├── Dau.DX.API_개발계획/   ← PRD 12종 (현재 위치, Phase 0)
...
| 카테고리 | 책임 | 채워지는 시점 |
|---|---|---|
| `Dau.DX.API_개발계획/` | 아키텍트, PO | M0 (현재) |
| `guides/` | 각 영역 시니어 | Phase 1 부트스트랩 ~ |
| `standards/` | 아키텍트 + 팀 | Phase 1 시작 ~ |
| `operations/` | DevOps + 운영팀 | M5 ~ M6 |
