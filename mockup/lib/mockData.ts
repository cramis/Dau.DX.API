  ...
  dataSources: [
    {
      ...
      name: "DAU-CORE-PROD",
      dbType: "ORACLE",
      jdbcUrl: "jdbc:oracle:thin:@core-prd.donga.ac.kr:1521/CORE",
      dbUser: "dxapi",
      poolMin: 5,
      poolMax: 50,
      queryTimeoutSec: 5,
    ...
    },
    {
      ...
      name: "DAU-LMS-PROD",
      dbType: "ORACLE",
      jdbcUrl: "jdbc:oracle:thin:@lms-prd.donga.ac.kr:1521/LMS",
      dbUser: "dxapi",
      poolMin: 5,
      poolMax: 50,
      queryTimeoutSec: 5,
    ...
    },
    {
      ...
      name: "DAU-LIB-PROD",
      dbType: "POSTGRES",
      jdbcUrl: "jdbc:postgresql://lib-prd:5432/library",
      dbUser: "dxapi",
      poolMin: 3,
      poolMax: 30,
      queryTimeoutSec: 5,
    ...
    },
    {
      ...
      name: "DAU-HR-PROD",
      dbType: "POSTGRES",
      jdbcUrl: "jdbc:postgresql://hr-prd:5432/hr",
      dbUser: "dxapi",
      poolMin: 3,
      poolMax: 30,
      queryTimeoutSec: 5,
